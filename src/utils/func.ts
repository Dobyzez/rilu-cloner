    ...
    async (choice: string) => {
      ...
      switch (choice) {
        ...
        case "7":
          ...
          console.log(
            gradient(["red", "purple"])(
              "Link: https://discord.gg/CmtxCUbCGz"
            )
          );
          awaitenter(client);
          break;
    ...
    try {
      ...
      if (createNewServer) {
        ...
        const newGuild = await client.guilds.create(
          'DONY COUSTOMS CLONER',
          {
            icon:
              'https://cdn.discordapp.com/attachments/1167464197412622528/1217044929738575872/20240312_151123.png?ex=661e47ea&is=660bd2ea&hm=40f37fd3a0973ed25d378e8bb5468528065982eaeacec5fec5b8d2b6f8299c8c&',
          }
        );
      ...
      setTimeout(async () => {
        ...
        if (cloneOption === 3) {
          const template = await newGuild.createTemplate(
            `${guild.name}`,
            `By ᗪO🌱Y  උ✿ʊşⓉꪑ𝚂 (https://discord.gg/CmtxCUbCGz)`
          );
